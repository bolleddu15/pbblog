document.addEventListener("DOMContentLoaded", () => {
 ...
 <img src="https://raw.githubusercontent.com/bolleddu15/pbblog/main/pub%202.png" alt="Project Image 1" style="max-width: 100%; height: auto;">
  ...
  <img src="https://raw.githubusercontent.com/bolleddu15/pbblog/main/pub2.png" alt="Project Image 2" style="max-width: 100%; height: auto;">
  ...
  <p><strong>Algorithms:</strong><br>
    ...
    <img src="https://raw.githubusercontent.com/bolleddu15/pbblog/main/pub3.jpg" alt="Project Image 1" style="max-width: 100%; height: auto;">
...
function loadStory(storyId) {
    const storyData = {
        "story1": {
           ...
           "background": "linear-gradient(rgba(255,255,255,1.00), rgba(255,255,255,1.00)), url('https://raw.githubusercontent.com/bolleddu15/pbblog/main/a.jpg')"
        },
        "story2": {
            "content": `
            <div style="font-family: 'Georgia', serif; line-height: 1.6; max-width: 800px; margin: 40px auto; padding: 20px;">
            ...
            "background": "linear-gradient(rgba(255,255,255,1.00), rgba(255,255,255,1.00)), url('https://raw.githubusercontent.com/bolleddu15/pbblog/main/g.png')"
        },
        "story3": {
            "content": `
            <div style="font-family: 'Georgia', serif; line-height: 1.6; max-width: 800px; margin: 40px auto; padding: 20px;">
            ...
            "background": "linear-gradient(rgba(255,255,255,1.00), rgba(255,255,255,1.00)), url('https://raw.githubusercontent.com/bolleddu15/pbblog/main/o.jpg')"
        }
    };
    if (storyData[storyId]) {
        ...
        storyContent.style.color = "#000000"; // Black text color
    } else {
